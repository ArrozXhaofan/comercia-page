...
export default function Sublimacion({ setProducto, setIndicePro }) {
    ...
    const jalarBanner = () => {
        var url = 'https://comercializadora.apexmaicol.online/items/readS.php'
        fetch(url)
            .then((res) => res.json())
            .then(res => {
                setDatosBanner(res)
    ...
    return (
        ...
        <div className='bg-comercia-five h-full lg:h-screen lg:grid lg:grid-cols-7 text-center 2xl:grid-rows-2'>
            ...
            <header className='text-center lg:w-3/12 py-4 flex flex-col md:grid md:grid-cols-5 lg:flex lg:fixed h-full lg:pl-2 lg:justify-between'>
                ...
                <div className='md:col-span-5 lg:flex lg:text-start md:pb-8 p-2 2xl:justify-center'>
                    <h1 className='font-monse text-4xl lg:text-4xl  2xl:text-6xl xl:text-4xl lg:text-center text-white font-black'><i>SUBLIMACIÓN</i></h1>
                </div>
